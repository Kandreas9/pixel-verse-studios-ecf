...
export default function ModeratorDashboardItem({ moderator }) {
                ...
                <div className="flex flex-col items-end justify-start gap-1 md:flex-row md:items-start md:justify-end">
                    {isDeleteClicked ? (
                        <Link
                            ...
                            as="button"
                            method="delete"
                            href={`/dashboard/users/${moderator.id}`}
                        >
                            Sure?
                        </Link>
                    ) : (
                    ...
                    <Link
                        className="flex h-8 cursor-pointer items-center rounded-md bg-blue-400 px-3 text-[.9rem]"
                        href={`/dashboard/moderators/${moderator.id}/password/edit`}
                    >
                        Edit
                    </Link>
                </div>
